...
Begin VB.UserControl ucFarmHistoricoPrecios 
   ClientHeight    =   6405
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   11070
   ...
   Begin VB.Frame fraBusqueda 
      ...
      Begin VB.CommandButton btnLimpiar 
         Height          =   315
         Left            =   9585
         Picture         =   "ucFarmHistoricoPrecios.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   285
         Width           =   1275
      ...
      Begin VB.CommandButton btnBuscar 
         Height          =   315
         Left            =   8220
         Picture         =   "ucFarmHistoricoPrecios.ctx":2BDC
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   285
         Width           =   1305
   ...
   End
End
Attribute VB_Name = "ucFarmHistoricoPrecios"
