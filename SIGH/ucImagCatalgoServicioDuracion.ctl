...
Begin VB.UserControl ucImagCatServDuracion 
   ...
   Begin UltraGrid.SSUltraGrid grdCatalogoServicio 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "Lista de Catálogo de Servicios"
   End
   Begin VB.Label lblNombre 
      BackColor       =   &H00373842&
      Caption         =   "Listado de Catálogo de Servicios de Imagenología"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   18
         Charset         =   0
...
Public Sub RealizarBusqueda()
    ...
    If mo_reglaImagen.MensajeError <> "" Then
        MsgBox mo_reglaImagen.MensajeError, vbInformation, "Filtro de catálogo de servicios"
    End If
...
Private Sub grdCatalogoServicio_InitializeLayout(ByVal Context As UltraGrid.Constants_Context, ByVal Layout As UltraGrid.SSLayout)
    ...
    grdCatalogoServicio.Bands(0).Columns("Codigo").Header.Caption = "Código"
    ...
    grdCatalogoServicio.Bands(0).Columns("DuracionEnMin").Header.Caption = "Duración"
