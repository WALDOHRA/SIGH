...
Begin VB.UserControl ucPendientePago 
   ClientHeight    =   5745
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9795
   ...
   Begin VB.Frame fraBusqueda 
      ...
      Begin VB.CommandButton btnBuscar 
         Height          =   315
         Left            =   7800
         Picture         =   "ucPendientesPago.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   450
         Width           =   1305
      ...
      Begin VB.CommandButton btnLimpiar 
         Height          =   315
         Left            =   9165
         Picture         =   "ucPendientesPago.ctx":2C49
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   450
         Width           =   1275
   ...
   End
End
Attribute VB_Name = "ucPendientePago"
