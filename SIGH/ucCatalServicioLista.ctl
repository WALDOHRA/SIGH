...
Public Sub RealizarBusqueda()
    If Trim(txtCodigo.Text) = "" And Trim(txtNombre.Text) = "" Then
        MsgBox "Tiene que registrar el Código o Parte del Nombre", vbCritical, ""
        Exit Sub
    End If
    ...
    Else
       txtCodigo.Text = ""
    End If
    Set grdServicios.DataSource = mo_ReglasCaja.FactCatalogoServiciosSeleccionarPorCodigoOnombre(txtCodigo.Text, txtNombre.Text)
    If mo_ReglasCaja.MensajeError <> "" Then
        MsgBox mo_ReglasCaja.MensajeError, vbCritical, "Busqueda del catálogo de servicios"
    End If
