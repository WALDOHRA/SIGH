...
Sub Form_Load()
       ...
       Case sghEliminar
           Me.Caption = "Eliminar programación"
       End Select
       ...
       Do While Not oRsTmp.EOF
          If oRsTmp.Fields!fecha = CDate(sFecha) Then
                ...
                If (dFechaInicio <= dFechaInicioProgramacion And dFechaFin >= dFechaFinProgracion) _
                    ...
                    If mi_Opcion = sghAgregar Then
                        oMensaje2.MostrarFormulario "RESPONSABLE fué programado en otra SALA para esa FECHA/HORA", Me.Caption
                        Set oMensaje2 = Nothing
       ...
       Do While Not oRsTmp.EOF
          If oRsTmp.Fields!fecha = CDate(lcFecha) Then
                ...
                If (dFechaInicio <= dFechaInicioProgramacion And dFechaFin >= dFechaFinProgracion) _
                    ...
                    If mi_Opcion = sghAgregar Then
                        oMensaje2.MostrarFormulario "El PUNTO DE CARGA elegido ya fué programado para esa FECHA/HORA, al RESPONSABLE: " & Trim(oRsTmp.Fields!ApellidoPaterno) & " " & Trim(oRsTmp.Fields!ApellidoMaterno) & " " & Trim(oRsTmp.Fields!Nombres), Me.Caption
                        Set oMensaje2 = Nothing
                        ExisteProgramacionParaEseServicioFecha = True
                        Exit Function
                    ElseIf mi_Opcion = sghModificar And oRsTmp!IdProgramacion <> ml_IdProgramacion Then
                        oMensaje2.MostrarFormulario "El PUNTO DE CARGA elegido ya fué programado para esa FECHA/HORA, al RESPONSABLEo: " & Trim(oRsTmp.Fields!ApellidoPaterno) & " " & Trim(oRsTmp.Fields!ApellidoMaterno) & " " & Trim(oRsTmp.Fields!Nombres), Me.Caption
                        ExisteProgramacionParaEseServicioFecha = True
                        Set oMensaje2 = Nothing
                        Exit Function
                    End If
