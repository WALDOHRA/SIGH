...
Begin VB.UserControl ucLaboratorioProg 
   ClientHeight    =   8400
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   13440
   ...
   Begin VB.Label lblNombre 
      BackColor       =   &H00373842&
      Caption         =   "Programación en Laboratorio"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   18
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "ucLaboratorioProg"
...
Sub RefrescarListaMedicos()
    ...
    Set lstMedicos.RowSource = mo_ReglasConfiguarcionReslab.LabGruposSeleccionarTodos
    lstMedicos.Tag = ""
