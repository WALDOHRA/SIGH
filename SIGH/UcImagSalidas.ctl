...
Begin VB.UserControl UcImagSalidas 
   ClientHeight    =   8055
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   10935
   ...
   Begin VB.Frame fraBusqueda 
      ...
      Begin VB.CommandButton btnLimpiar 
         Height          =   315
         Left            =   9420
         Picture         =   "UcImagSalidas.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   540
         Width           =   1275
      ...
      Begin VB.CommandButton btnBuscar 
         Height          =   315
         Left            =   9420
         Picture         =   "UcImagSalidas.ctx":2BDC
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   210
         Width           =   1305
   ...
   End
End
Attribute VB_Name = "UcImagSalidas"
...
'        Programa: Control para lista de Salidas de insumos
...
Public Sub RealizarBusqueda()
        ...
        End If
        Set oRsLista = mo_reglasImagen.ImagMovimientoSeleccionarPorFechasPuntoCargaSalidas(Val(mo_cmbIdPuntoCarga.BoundText), ldFechaIni, ldFechaFin)
        If lcFiltro <> "" Then
