...
Begin VB.UserControl ucEstablecimientosNoMinsaL 
   ClientHeight    =   5640
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   10140
   ...
   End
End
Attribute VB_Name = "ucEstablecimientosNoMinsaL"
...
'        Programa: Control para buscar Establecimientos NO MINSA
...
Sub SkinConfigura()
  ...
  If sighentidades.Parametro282valorInt = "1" Then
        ...
        btnLimpiar.Caption = ""
        mo_Apariencia.ConfigurarFilasBiColores grdEstablecimientosNoMinsa, "99"
