...
Begin VB.UserControl UcLabIngresos 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   ...
   Begin VB.Frame fraBusqueda 
      ...
      Begin VB.CommandButton btnBuscar 
         Height          =   315
         Left            =   9420
         Picture         =   "UcLabIngresos.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   210
         Width           =   1305
      ...
      Begin VB.CommandButton btnLimpiar 
         Height          =   315
         Left            =   9420
         Picture         =   "UcLabIngresos.ctx":2C49
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   540
         Width           =   1275
   ...
   End
End
Attribute VB_Name = "UcLabIngresos"
...
'        Programa: Control para lista de Ingresos de Insumos de Laboratorio
...
Private Sub btnBuscar_Click()
    'Frank 03022015
    If UserControl.txtFinicio.Text = sighEntidades.FECHA_VACIA_DMY Or UserControl.txtFfinal.Text = sighEntidades.FECHA_VACIA_DMY Then
        Exit Sub
    End If
...
Public Sub RealizarBusqueda()
  ...
  Set oRsLista = mo_ReglasLaboratorio.LabMovimientoSeleccionarPorFechasPuntoCargaIngresos(Val(mo_cmbIdPuntoCarga.BoundText), ldFechaIni, ldFechaFin)
...
Private Sub grdListaOrdenes_InitializeLayout(ByVal Context As UltraGrid.Constants_Context, ByVal Layout As UltraGrid.SSLayout)
  ...
  grdListaOrdenes.Bands(0).Columns("NroDocumento").Width = 2000
  grdListaOrdenes.Bands(0).Columns("Estado").Header.Caption = "Estado"
  grdListaOrdenes.Bands(0).Columns("Estado").Width = 2000
End Sub
