...
Begin VB.UserControl ucCajeroLista 
   ClientHeight    =   6180
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   10020
   ...
   Begin VB.Frame fraBusqueda 
      ...
      Begin VB.CommandButton btnLimpiar 
         Height          =   315
         Left            =   8475
         Picture         =   "ucCajeroLista.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   450
         Width           =   1275
      ...
      Begin VB.CommandButton btnBuscar 
         Height          =   315
         Left            =   7110
         Picture         =   "ucCajeroLista.ctx":2BDC
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   450
         Width           =   1305
   ...
   End
End
Attribute VB_Name = "ucCajeroLista"
...
'        Programa: Control para listar cajeros
...
Property Set DataSource(oValue As ADODB.Recordset)
    Set UserControl.grdCajeros.DataSource = oValue
End Property
Property Get DataSource() As ADODB.Recordset
    Set DataSource = UserControl.grdCajeros.DataSource
End Property
...
Public Sub RealizarBusqueda()
    ...
    Set grdCajeros.DataSource = mo_AdminCaja.RealizarFiltroCajeros(oEmpleado)
    If mo_AdminCaja.MensajeError <> "" Then
        MsgBox mo_AdminCaja.MensajeError, vbInformation, "Filtro de cajeros"
    End If
    mo_Apariencia.ConfigurarFilasBiColores grdCajeros, SIGHEntidades.GrillaConFilasBicolor
End Sub
...
Dim rsRecordset As ADODB.Recordset
    ...
    ml_idRegistroSeleccionado = rsRecordset("IdCajero")
...
Private Sub grdCajeros_InitializeLayout(ByVal Context As UltraGrid.Constants_Context, ByVal Layout As UltraGrid.SSLayout)
    ...
    grdCajeros.Bands(0).Columns("IdCajero").Hidden = True
    grdCajeros.Bands(0).Columns("IdEmpleado").Hidden = True
    
    grdCajeros.Bands(0).Columns("EstadoCajero").Header.Caption = "Activo"
    grdCajeros.Bands(0).Columns("EstadoCajero").Width = 500
    
    grdCajeros.Bands(0).Columns("ApellidoPaterno").Header.Caption = "Ap.Paterno"
    grdCajeros.Bands(0).Columns("ApellidoPaterno").Width = 2000
    
    grdCajeros.Bands(0).Columns("ApellidoMaterno").Header.Caption = "Ap.Materno"
    grdCajeros.Bands(0).Columns("ApellidoMaterno").Width = 2000
    
    grdCajeros.Bands(0).Columns("Nombres").Header.Caption = "Nombres"
    grdCajeros.Bands(0).Columns("Nombres").Width = 3000
...
Private Sub UserControl_Resize()
   ...
   grdCajeros.Width = fraBusqueda.Width
   grdCajeros.Height = UserControl.Height - (lblNombre.Height + fraBusqueda.Height + 150)
