...
Begin VB.Form FacOrdenServicioDetalle 
   ...
   ClientTop       =   450
   ClientWidth     =   13860
   Icon            =   "FacturacionOrdenDetalle.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   ScaleHeight     =   8880
   ScaleWidth      =   13860
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton btnAceptar 
         Caption         =   "Aceptar (F2)"
         DisabledPicture =   "FacturacionOrdenDetalle.frx":000C
         DownPicture     =   "FacturacionOrdenDetalle.frx":046C
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
         ...
         Height          =   700
         Left            =   5340
         Picture         =   "FacturacionOrdenDetalle.frx":08E1
         Style           =   1  'Graphical
         TabIndex        =   0
         Top             =   240
         Width           =   1365
      ...
      Begin VB.CommandButton btnCancelar 
         ...
         DisabledPicture =   "FacturacionOrdenDetalle.frx":0D56
         DownPicture     =   "FacturacionOrdenDetalle.frx":121A
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
         ...
         Height          =   700
         Left            =   6870
         Picture         =   "FacturacionOrdenDetalle.frx":1706
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   225
         Width           =   1365
   ...
   Begin VB.Frame fraDatosAtencion 
      ...
      Begin VB.CommandButton btnBuscarPaciente 
         Height          =   315
         Left            =   7470
         Picture         =   "FacturacionOrdenDetalle.frx":1BF2
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   2040
         Width           =   1305
...
Dim rsPaciente As Recordset
    ...
    Set rsPaciente = Me.grdPacientesEncontrados.DataSource
     ...
     txtPaciente = rsPaciente!ApellidoPaterno + " " + rsPaciente!ApellidoMaterno + " " + rsPaciente!PrimerNombre
...
Private Sub txtNroOrdenSisSoat_Change()
