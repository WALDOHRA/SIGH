...
Begin VB.UserControl ucPreLiqProcedimientosLista 
   ClientHeight    =   5970
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   10125
   ...
   Begin VB.Frame fraBusqueda 
      ...
      Begin VB.CommandButton btnBuscar 
         Height          =   315
         Left            =   4140
         Picture         =   "ucPreLiqProcedimientosLista.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   240
         Width           =   495
   ...
   Begin VB.Label lblNombre 
      BackColor       =   &H00808080&
      Caption         =   "Pre-Liquidacion de Procedimientos"
      BeginProperty Font 
         Name            =   "Verdana"
         Size            =   20.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "ucPreLiqProcedimientosLista"
