...
Dim oDOEmpleado As New dOEmpleado
        ...
        If lcBuscaParametro.SeleccionaFilaParametro(264) = "S" And (ml_IdTipoServicio = 2 Or ml_IdTipoServicio = 4) Then
           ...
           Set grdMedicos.DataSource = mo_AdminProgramacionMedica.MedicosProgramadosFiltrar(oDoMedico, oDOEmpleado, ml_IdEspecialidad, md_FechaProgramada, ml_HoraProgramada, ml_IdTipoServicio)
        Else
...
Sub SkinConfigura()
  ...
  If sighentidades.Parametro282valorInt = "1" Then
        ...
        btnLimpiar.Caption = ""
        mo_Apariencia.ConfigurarFilasBiColores grdMedicos, "99"
