...
Begin VB.UserControl ucLoteCuadreLista 
   ClientHeight    =   6210
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   10050
   ...
   Begin VB.Frame fraBusqueda 
      ...
      Begin VB.CommandButton btnLimpiar 
         Height          =   315
         Left            =   8535
         Picture         =   "ucLoteCuadreLista.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   450
         Width           =   1215
      ...
      Begin VB.CommandButton btnBuscar 
         Height          =   315
         Left            =   7170
         Picture         =   "ucLoteCuadreLista.ctx":2BDC
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   450
         Width           =   1305
   ...
   End
End
Attribute VB_Name = "ucLoteCuadreLista"
...
Public Sub RealizarBusqueda()
    ...
    Set grdLotes.DataSource = mo_AdminCaja.RealizarFiltroLoteCuadres(oLote)
...
Dim rsRecordset As ADODB.Recordset
    ...
    ml_IdRegistroSeleccionado = rsRecordset("IdLoteCuadre")
...
Private Sub grdLotes_InitializeLayout(ByVal Context As UltraGrid.Constants_Context, ByVal Layout As UltraGrid.SSLayout)
    ...
    grdLotes.Bands(0).Columns("IdLoteCuadre").Hidden = True
    ...
    grdLotes.Bands(0).Columns("Calculado").Header.Caption = "Calculado(S/.)"
    grdLotes.Bands(0).Columns("Calculado").Width = 1500

    grdLotes.Bands(0).Columns("CuadreUsuario").Header.Caption = "Cuadre Usuario(S/.)"
    grdLotes.Bands(0).Columns("CuadreUsuario").Width = 1500

    grdLotes.Bands(0).Columns("Diferencia").Header.Caption = "Diferencia(S/.)"
    grdLotes.Bands(0).Columns("Diferencia").Width = 1500
End Sub
