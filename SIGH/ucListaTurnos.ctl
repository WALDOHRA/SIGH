...
Begin VB.UserControl ucTurnosLista 
   ClientHeight    =   5985
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   10185
   ...
   Begin VB.Frame fraBusqueda 
      ...
      Begin VB.CommandButton btnLimpiar 
         Height          =   315
         Left            =   5505
         Picture         =   "ucListaTurnos.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   240
         Width           =   1275
      ...
      Begin VB.CommandButton btnBuscar 
         Height          =   315
         Left            =   4140
         Picture         =   "ucListaTurnos.ctx":2BDC
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   240
         Width           =   1305
   ...
   End
End
Attribute VB_Name = "ucTurnosLista"
...
Sub SkinConfigura()
  ...
  If sighentidades.Parametro282valorInt = "1" Then
        ...
        btnLimpiar.Caption = ""
        mo_Apariencia.ConfigurarFilasBiColores grdTurnos, "99"
