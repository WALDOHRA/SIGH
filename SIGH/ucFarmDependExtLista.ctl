...
Begin VB.UserControl ucFarmDependExtLista 
   ClientHeight    =   6225
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   10035
   ...
   Begin UltraGrid.SSUltraGrid grdLista 
      ...
      EndProperty
      Caption         =   "Lista de Depenencias Externas"
   End
   ...
   End
End
Attribute VB_Name = "ucFarmDependExtLista"
...
'        Programa: Control para lista de Dependencias Externas
...
Public Sub RealizarBusqueda()
    Set grdLista.DataSource = mo_ReglasFarmacia.FarmAlmacenesDevuelveListaDependenciasExternas
