...
Begin VB.UserControl ucFarmNsLista 
   ClientHeight    =   6555
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   11205
   ...
   Begin VB.Frame fraBusqueda 
      ...
      Begin VB.CommandButton btnBuscar 
         Height          =   315
         Left            =   8220
         Picture         =   "ucFarmNsLista.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   450
         Width           =   1305
      ...
      Begin VB.CommandButton btnLimpiar 
         Height          =   315
         Left            =   9585
         Picture         =   "ucFarmNsLista.ctx":2C49
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   450
         Width           =   1275
      ...
      Begin VB.Label Label2 
         Caption         =   "Fecha Inicial      Fecha Final"
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "ucFarmNsLista"
...
'        Programa: Control para buscar nota de Salida
...
Dim lbNSsoloParaFarmacia As Boolean

Property Let NSsoloParaFarmacia(lValue As Long)
   lbNSsoloParaFarmacia = lValue
End Property
