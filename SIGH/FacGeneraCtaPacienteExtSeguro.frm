...
Sub ImprimePreCuenta()
    ...
    lcCola = ""
    oReporte.ImpresionPreCuenta Me.txtFechaIngreso.Text, Me.txtHoraIngreso.Text, lcPaciente, _
               ...
               If mo_ReglasSISgalenhos.PacienteBuscadoEnTablaGalenHosTieneAfiliacionSIS(lcDNI_busqueda, _
                   ...
                   If oRsBuscaPacientesSis.RecordCount > 0 Then
                      If mo_ReglasSISgalenhos.Sis_ValidaSiEsAfiliadoActualDelSIS(oRsBuscaPacientesSis, ldFechaActualServidor, True) = True Then
                       ...
                       Else
                            MsgBox "Esa Filiación del Paciente ya venció"
