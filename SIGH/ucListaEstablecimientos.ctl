...
'        Programa: Control para buscar Establecimientos
...
Dim oEstablecimiento As New DOEstablecimiento
        ...
        oEstablecimiento.Codigo = UserControl.txtCodigo
        oEstablecimiento.Nombre = UserControl.txtNombre
        oEstablecimiento.IdDistrito = Val(mo_cmbIdDistrito.BoundText)
        Set grdEstablecimientos.DataSource = mo_AdminReglasCOmunes.EstablecimientosFiltrar(oEstablecimiento, Val(mo_cmbIdDepartamento.BoundText), Val(mo_cmbIdProvincia.BoundText))
