...
Begin VB.UserControl ucPrestamoHCLista 
   ClientHeight    =   6390
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   10125
   ...
   Begin VB.Frame fraBusqueda 
      ...
      Begin VB.CommandButton btnBuscar 
         Height          =   315
         Left            =   8400
         Picture         =   "ucPrestamoHCLista.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   420
         Width           =   585
      ...
      Begin VB.Label Label1 
         Caption         =   "Fecha solicitud                  Fecha préstamo                 Fecha devolución               ID envío"
         Height          =   225
         Left            =   180
         TabIndex        =   13
         Top             =   810
   ...
   Begin UltraGrid.SSUltraGrid grdPrestamosHC 
      ...
      Caption         =   "Lista de prestamos y devoluciones"
   End
   Begin VB.Label lblNombre 
      BackColor       =   &H00808080&
      Caption         =   "Prestamos Historia Clínica"
      BeginProperty Font 
         Name            =   "Verdana"
         Size            =   18
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "ucPrestamoHCLista"
...
Private Sub grdPrestamosHC_RowColChange(LastRow As Variant, ByVal LastCol As Integer)
...
Private Sub grdPrestamosHC_InitializeLayout(ByVal Context As UltraGrid.Constants_Context, ByVal Layout As UltraGrid.SSLayout)
    ...
    grdPrestamosHC.Bands(0).Columns("FechaSolicitud").Width = 1200
    
    grdPrestamosHC.Bands(0).Columns("FechaPrestamoRequerida").Header.Caption = "Fecha Prest."
    grdPrestamosHC.Bands(0).Columns("FechaPrestamoRequerida").Width = 1200
    
    grdPrestamosHC.Bands(0).Columns("FechaDevolucion").Header.Caption = "Fecha Devol."
    grdPrestamosHC.Bands(0).Columns("FechaDevolucion").Width = 1200
    ...
    grdPrestamosHC.Bands(0).Columns("Observacion").Width = 2500
    
    grdPrestamosHC.Bands(0).Columns("NroFolios").Header.Caption = "Nº Folio"
    grdPrestamosHC.Bands(0).Columns("NroFolios").Width = 1000
