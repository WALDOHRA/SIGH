...
Begin VB.UserControl ucFarmIntervencionLista 
   ClientHeight    =   6555
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   11205
   ...
   Begin VB.Frame fraBusqueda 
      ...
      Begin VB.CommandButton btnBuscar 
         Height          =   315
         Left            =   8220
         Picture         =   "ucFarmIntervencionLista.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   450
         Width           =   1305
      ...
      Begin VB.CommandButton btnLimpiar 
         Height          =   315
         Left            =   9585
         Picture         =   "ucFarmIntervencionLista.ctx":2C49
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   450
         Width           =   1275
   ...
   Begin VB.Label lblNombre 
      BackColor       =   &H00373842&
      Caption         =   "Intervención Sanitaria"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   18
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "ucFarmIntervencionLista"
...
'        Programa: Control para buscar Intervensiones SAnitarias
...
Public Sub RealizarBusqueda()
        If cmbAlmacen.Text = "" Then
           ...
           Exit Sub
        End If
        Set oRsBusqueda = mo_ReglasFarmacia.FarmMovimientoProgramasSeleccionarPorFechas(Val(cmbAlmacen.BoundText), CDate(Format(txtFinicio.Text & " 00:00:01", SIGHEntidades.DevuelveFechaSoloFormato_DMY_HMS)), CDate(Format(txtFfinal.Text & " 23:59:59", SIGHEntidades.DevuelveFechaSoloFormato_DMY_HMS)))
        ...
        ElseIf mo_Teclado.TextoEsSoloNumeros(txtNGuia.Text) Then
