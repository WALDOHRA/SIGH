...
Begin VB.Form SiCitaDetalle 
   ...
   Begin VB.Frame fraDatosAtencion 
      ...
      Begin VB.CommandButton cmdBuscaCuentaPorApellidos 
         Height          =   330
         Left            =   2475
         Picture         =   "SiCitaDetalle.frx":08CA
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   615
         Width           =   300
      ...
      Begin VB.CommandButton cmbBuscaReceta 
         Height          =   330
         Left            =   2475
         Picture         =   "SiCitaDetalle.frx":0E54
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   1035
         Width           =   300
      ...
      Begin UltraGrid.SSUltraGrid grdConsumoPaciente 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Appearance      =   "SiCitaDetalle.frx":13DE
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton btnCancelar 
         ...
         DisabledPicture =   "SiCitaDetalle.frx":141A
         DownPicture     =   "SiCitaDetalle.frx":18DE
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
         ...
         Height          =   700
         Left            =   6870
         Picture         =   "SiCitaDetalle.frx":1DCA
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   240
         Width           =   1365
      ...
      Begin VB.CommandButton btnAceptar 
         Caption         =   "Aceptar (F2)"
         DisabledPicture =   "SiCitaDetalle.frx":22B6
         DownPicture     =   "SiCitaDetalle.frx":2716
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
         ...
         Height          =   700
         Left            =   5340
         Picture         =   "SiCitaDetalle.frx":2B8B
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   240
         Width           =   1365
      ...
      Begin VB.CommandButton btnImprimir 
         ...
         Height          =   700
         Left            =   120
         Picture         =   "SiCitaDetalle.frx":3000
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   240
         Visible         =   0   'False
   ...
   End
End
Attribute VB_Name = "SiCitaDetalle"
...
'    CalculaHoraFinal = mo_AdminProgramacionMedica.ConvertirAHora(lHoraSiguiente)
'End Function
...
Function AgregarDatos() As Boolean
    ...
    AgregarDatos = mo_ReglasImagenes.SICitasMantenimiento(DoSiCitas, rsProductosCPT, mo_lnIdTablaLISTBARITEMS, _
                                                          mo_lcNombrePc, sghAgregar, False, lnNroMinutos)
...
Sub CargaDatosPuntoCarga()
    ...
    lnNumeroCitas = oRsTmp9.RecordCount
    If lnNumeroCitas > 0 Then
...
Private Sub btnImprimir_Click()
   ...
   oRptCaja.ImprimeCitas DoSiCitas, sghLaboratorio, lcHistoria, lcFinanciamiento, ""
