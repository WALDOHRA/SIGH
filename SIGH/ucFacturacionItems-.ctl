...
Dim rs As Recordset
    ...
    Case sghServicio
        ...
        If mo_ReglasFacturacion.TiposFinanciamientoGeneraReciboPago(ml_IdTipoFinanciamiento) Then
...
Dim oRow As SSRow
    ...
    If rs.RecordCount > 0 Then
       If rs.Fields("idproducto").Value <> lnIdPagosACuenta Then
            ...
            If Not ItemYaExiste(rs.Fields("idproducto").Value) Then
                ...
                oRow.Cells("SeUsaSinPrecio").Value = rs.Fields("SeUsaSinPrecio").Value
