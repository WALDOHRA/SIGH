...
Begin VB.Form rEcogObs 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Ecografía Obstétrica por Fechas"
   ClientHeight    =   3675
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9225
   Icon            =   "rEcogObs.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton btnAceptar 
         Caption         =   "Aceptar (F2)"
         DisabledPicture =   "rEcogObs.frx":12EE
         DownPicture     =   "rEcogObs.frx":174E
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
      ...
      Begin VB.CommandButton btnCancelar 
         ...
         DisabledPicture =   "rEcogObs.frx":2038
         DownPicture     =   "rEcogObs.frx":24FC
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
...
'        Programa: Reporte para Ecografía Obstétrica
