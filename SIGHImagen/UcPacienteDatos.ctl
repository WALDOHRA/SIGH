...
'        Programa: Control para ver datos personales del Paciente
...
Dim lcDireccionYtelefono As String
...
oConexion.CursorLocation = adUseClient
        ...
        If Not oPacientes Is Nothing Then
           With oPacientes
                ...
                ms_telefono = .TELEFONO
                ms_direccion = .DireccionDomicilio
                ...
                lcDireccionYtelefono = ""
                If .TELEFONO <> "" Then
                   lcDireccionYtelefono = lcDireccionYtelefono & " (Teléfono: " & .TELEFONO & ")"
                End If
                If .DireccionDomicilio <> "" Then
                   lcDireccionYtelefono = lcDireccionYtelefono & " (Dirección: " & .DireccionDomicilio & ")"
                End If
...
Public Function DevuelveDatosPersonales() As String
     DevuelveDatosPersonales = "Edad: " & txtEdad.Text & " (Sexo: " & _
                               IIf(mo_CmbIdTipoSexo.BoundText = "1", "M)", "F)") & _
                               lcDireccionYtelefono
End Function
...
Public Function DevuelvePaciente() As String
   DevuelvePaciente = "(" & SIGHEntidades.HCigualDNI_DevuelveHistoriaConCerosIzquierda(txtIdNroHistoria.Text, False) & _
                      ")" & Trim(txtApellidoPaterno.Text) & " " & Trim(txtApellidoMaterno.Text) & " " & Trim(txtPrimerNombre.Text)
   
End Function

Public Sub habilitar(lbHabilitar As Boolean)
    fraDatosPaciente.Enabled = lbHabilitar
End Sub
