...
Begin VB.Form ImagEcogGen 
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton btnAceptar 
         Caption         =   "Aceptar (F2)"
         DisabledPicture =   "ImagEcogGen.frx":11A3
         DownPicture     =   "ImagEcogGen.frx":1603
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
      ...
      Begin VB.CommandButton btnCancelar 
         ...
         DisabledPicture =   "ImagEcogGen.frx":1EED
         DownPicture     =   "ImagEcogGen.frx":23B1
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
   ...
   Begin VB.Frame fraDatosAtencion 
      ...
      Begin UltraGrid.SSUltraGrid grdConsumoPaciente 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Appearance      =   "ImagEcogGen.frx":389D
...
Const ml_PuntoCarga As Long = 20      'Ecogr. General
...
Private Sub Form_Load()
    ...
    Select Case mi_Opcion
    Case sghAgregar
        Me.Caption = "Agregar Ecografía General"
    Case sghModificar
        Me.Caption = "Modificar Ecografía General"
    Case sghConsultar
        Me.Caption = "Consultar Ecografía General"
        btnImprimir.Visible = True
        fraDatosAtencion.Enabled = False
    Case sghEliminar
        Me.Caption = "Eliminar Ecografía General"
    End Select
...
Sub CargarDatosALosControles()
        ...
        Me.chkPlanNoCubre.Visible = False: txtDatosDeCuenta.Width = txtDatosDeCuenta.Width + chkPlanNoCubre.Width + 150
    ...
    If Val(txtNreceta.Text) > 0 Then
       ...
       If oRsTmp1.RecordCount > 0 Then
            If oRsTmp1.Fields!idEstado <> sghRecetaEstados.sighRecetaRegistrada Then
                ...
                txtNreceta.Text = ""
            Else
                If oRsTmp1.Fields!IdPuntoCarga <> sghPtoCargaEcogGeneral Then
                     MsgBox "Esa receta no es de ECOGRAFIA GENERAL", vbInformation, "Imágenes"
                     txtNreceta.Text = ""
                Else
                     lbCuentaDeEmergenciaCerrada = mo_reglasComunes.CuentaDeEmergenciaCerrada(oRsTmp1!idCuentaAtencion, sghPtoCargaEcogGeneral)
...
Private Sub cmbBuscaReceta_Click()
    ...
    oBusqueda.IdPuntoCarga = sghPtoCargaEcogGeneral
    oBusqueda.MostrarFormulario
    If oBusqueda.BotonPresionado = sghAceptar Then
