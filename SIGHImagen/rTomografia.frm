...
Begin VB.Form rTomografia 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Tomografía por Fechas"
   ClientHeight    =   3675
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9225
   Icon            =   "rTomografia.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton btnAceptar 
         Caption         =   "Aceptar (F2)"
         DisabledPicture =   "rTomografia.frx":12EE
         DownPicture     =   "rTomografia.frx":174E
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
      ...
      Begin VB.CommandButton btnCancelar 
         ...
         DisabledPicture =   "rTomografia.frx":2038
         DownPicture     =   "rTomografia.frx":24FC
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
...
'        Programa: Reporte para Tomografía
...
Private Sub btnAceptar_Click()
    If ValidaDatosObligatorios Then
        ...
        oRptClaseCry.IdPuntoCarga = 22
        oRptClaseCry.EnResumen = IIf(chkResumen.Value = 1, True, False)
...
Function ValidaDatosObligatorios() As Boolean
    ...
    End If
    sMensaje = ""
    ml_TextoDelFiltro = "FILTROS:   F.Movimiento: (" & txtFdesde.Text & " " & txtHrInicio.Text & "   al " & txtFhasta.Text & " " & txtHrFin.Text & ")     "
    If sMensaje <> "" Then
