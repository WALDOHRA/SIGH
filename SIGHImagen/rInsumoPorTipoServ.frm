...
Begin VB.Form rInsumoPorTipoServ 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Consumo de Insumos por Tipo de Servicio"
   ClientHeight    =   3675
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9225
   Icon            =   "rInsumoPorTipoServ.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Frame fraDatosHistoria 
      ...
      Top             =   0
      Width           =   9195
      Begin VB.CheckBox chkSoloMalogradas 
         Alignment       =   1  'Right Justify
         Caption         =   "Sólo falladas"
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
         ...
         Height          =   315
         Left            =   7635
         Picture         =   "rInsumoPorTipoServ.frx":0CCA
         TabIndex        =   13
         Top             =   600
         Width           =   1395
      End
      ...
      Begin VB.CheckBox chkExcel 
         ...
         Height          =   315
         Left            =   7905
         Picture         =   "rInsumoPorTipoServ.frx":0FDC
         TabIndex        =   10
         Top             =   930
         Width           =   1125
      End
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton btnAceptar 
         Caption         =   "Aceptar (F2)"
         DisabledPicture =   "rInsumoPorTipoServ.frx":12EE
         DownPicture     =   "rInsumoPorTipoServ.frx":174E
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
         ...
         Height          =   700
         Left            =   3210
         Picture         =   "rInsumoPorTipoServ.frx":1BC3
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   240
         Width           =   1365
      ...
      Begin VB.CommandButton btnCancelar 
         ...
         DisabledPicture =   "rInsumoPorTipoServ.frx":2038
         DownPicture     =   "rInsumoPorTipoServ.frx":24FC
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
         ...
         Height          =   700
         Left            =   4740
         Picture         =   "rInsumoPorTipoServ.frx":29E8
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   225
         Width           =   1365
   ...
   End
End
Attribute VB_Name = "rInsumoPorTipoServ"
...
'        Programa: Reporte de Insumo por Tipo Servicio
...
Private Sub btnAceptar_Click()
    If ValidaDatosObligatorios Then
        ...
        oRptClaseCry.ConsiderarRecalculo = IIf(chkSoloMalogradas.Value = 1, True, False)
...
Function ValidaDatosObligatorios() As Boolean
    ...
    End If
    sMensaje = ""
    ml_TextoDelFiltro = "FILTROS:   " & Trim(cmbIdPuntoDeCarga.Text) & "      F.Movimiento: (" & txtFdesde.Text & " " & txtHrInicio.Text & "   al " & txtFhasta.Text & " " & txtHrFin.Text & ")     " & IIf(chkSoloMalogradas.Value = 1, "(sólo falladas)", "(sin fallas)")
