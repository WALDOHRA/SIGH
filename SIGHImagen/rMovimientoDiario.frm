...
Begin VB.Form rMovimientoDiario 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Movimiento diario de Entradas y Salidas"
   ClientHeight    =   3675
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9225
   Icon            =   "rMovimientoDiario.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Frame fraDatosHistoria 
      ...
      Begin VB.CheckBox chkExcel 
         ...
         Height          =   315
         Left            =   7920
         Picture         =   "rMovimientoDiario.frx":0CCA
         TabIndex        =   11
         Top             =   1050
         Width           =   1125
      End
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton btnAceptar 
         Caption         =   "Aceptar (F2)"
         DisabledPicture =   "rMovimientoDiario.frx":0FDC
         DownPicture     =   "rMovimientoDiario.frx":143C
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
         ...
         Height          =   700
         Left            =   3210
         Picture         =   "rMovimientoDiario.frx":18B1
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   240
         Width           =   1365
      ...
      Begin VB.CommandButton btnCancelar 
         ...
         DisabledPicture =   "rMovimientoDiario.frx":1D26
         DownPicture     =   "rMovimientoDiario.frx":21EA
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
         ...
         Height          =   700
         Left            =   4740
         Picture         =   "rMovimientoDiario.frx":26D6
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   225
         Width           =   1365
   ...
   End
End
Attribute VB_Name = "rMovimientoDiario"
...
'        Programa: Reporte Movimiento diario
...
Function ValidaDatosObligatorios() As Boolean
    ...
    End If
    sMensaje = ""
    ml_TextoDelFiltro = "FILTROS:   " & Trim(cmbIdPuntoDeCarga.Text) & "      F.Movimiento: (" & txtFdesde.Text & " " & txtHrInicio.Text & "   al " & txtFhasta.Text & " " & txtHrFin.Text & ")     " & IIf(chkSinMov.Value = 1, "(Todos los Productos)", "(Sólo Productos con Movimientos)")
