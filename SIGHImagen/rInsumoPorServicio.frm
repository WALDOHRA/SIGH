...
Begin VB.Form rInsumoPorServicio 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Consumo de Insumos por Servicio"
   ClientHeight    =   3675
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9225
   Icon            =   "rInsumoPorServicio.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin VB.Frame fraDatosHistoria 
      ...
      Top             =   0
      Width           =   9195
      Begin VB.ComboBox cmbTipoPaciente 
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
         ...
         EndProperty
         Height          =   330
         ItemData        =   "rInsumoPorServicio.frx":0CCA
         Left            =   5640
         List            =   "rInsumoPorServicio.frx":0CDD
      ...
      Begin VB.CheckBox chkExcel 
         ...
         Height          =   315
         Left            =   7920
         Picture         =   "rInsumoPorServicio.frx":0D3C
         TabIndex        =   10
         Top             =   1050
         Width           =   1125
      End
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton btnAceptar 
         Caption         =   "Aceptar (F2)"
         DisabledPicture =   "rInsumoPorServicio.frx":104E
         DownPicture     =   "rInsumoPorServicio.frx":14AE
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
         ...
         Height          =   700
         Left            =   3210
         Picture         =   "rInsumoPorServicio.frx":1923
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   225
         Width           =   1365
      ...
      Begin VB.CommandButton btnCancelar 
         ...
         DisabledPicture =   "rInsumoPorServicio.frx":1D98
         DownPicture     =   "rInsumoPorServicio.frx":225C
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
         ...
         Height          =   700
         Left            =   4740
         Picture         =   "rInsumoPorServicio.frx":2748
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   225
         Width           =   1365
   ...
   End
End
Attribute VB_Name = "rInsumoPorServicio"
...
'        Programa: Reporte Insumos por Servicio
...
Private Sub btnAceptar_Click()
    If ValidaDatosObligatorios Then
        ...
        oRptClaseCry.OrdenadoPor = cmbTipoPaciente.ListIndex
...
Function ValidaDatosObligatorios() As Boolean
    ...
    End If
    sMensaje = ""
    ml_TextoDelFiltro = "FILTROS:   " & Trim(cmbIdPuntoDeCarga.Text) & "      F.Movimiento: (" & txtFdesde.Text & " " & txtHrInicio.Text & "   al " & txtFhasta.Text & " " & txtHrFin.Text & ")      (" & Trim(cmbTipoPaciente.Text) & ")"
