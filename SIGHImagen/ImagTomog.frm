...
Begin VB.Form ImagTomog 
   ...
   Begin VB.Frame fraDatosAtencion 
      ...
      Begin VB.Label Label11 
         AutoSize        =   -1  'True
         Caption         =   "% para Informe Radiológico"
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9.75
            Charset         =   0
...
'        Programa: Mantenimiento de Tomografía
...
Private Sub Form_Load()
    ...
    Select Case mi_Opcion
    Case sghAgregar
        Me.Caption = "Agregar Tomografía"
    Case sghModificar
        Me.Caption = "Modificar Tomografía"
    Case sghConsultar
        Me.Caption = "Consultar Tomografía"
        btnImprimir.Visible = True
        fraDatosAtencion.Enabled = False
    Case sghEliminar
        Me.Caption = "Eliminar Tomografía"
    End Select
       ...
       If oRsTmp1.RecordCount > 0 Then
            ...
            Else
                If oRsTmp1.Fields!IdPuntoCarga <> sghPtoCargaTomografia Then
                     MsgBox "Esa receta no es de TOMOGRAFIA", vbInformation, "Imágenes"
                     txtNreceta.Text = ""
                Else
