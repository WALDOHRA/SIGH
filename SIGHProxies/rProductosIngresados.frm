...
Begin VB.Form rProductosIngresados 
   ...
   Begin TabDlg.SSTab tabReportes 
      ...
      Tab(0).Control(0)=   "CmbFiltro"
      Tab(0).Control(1)=   "TxtBusca"
      Tab(0).Control(2)=   "fraCabecera"
      Tab(0).Control(3)=   "Frame3"
      Tab(0).Control(4)=   "grdProductos"
      ...
      Begin VB.ComboBox CmbFiltro 
         Height          =   330
         ItemData        =   "rProductosIngresados.frx":0D02
         Left            =   -74235
         List            =   "rProductosIngresados.frx":0D0C
         TabIndex        =   47
         Top             =   6285
         Width           =   1815
      End
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox cmbTproducto 
            Height          =   330
            ItemData        =   "rProductosIngresados.frx":0D28
            Left            =   6630
            List            =   "rProductosIngresados.frx":0D35
            TabIndex        =   40
            Top             =   270
            Width           =   2760
         End
         Begin VB.CommandButton cmbRealizarBusqueda 
            Height          =   315
            Left            =   12240
            Picture         =   "rProductosIngresados.frx":0D59
            Style           =   1  'Graphical
            TabIndex        =   38
            Top             =   315
            Width           =   1305
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.CommandButton cmdSalir 
            ...
            DisabledPicture =   "rProductosIngresados.frx":39A2
            DownPicture     =   "rProductosIngresados.frx":3E66
            Height          =   700
            Left            =   6998
            Picture         =   "rProductosIngresados.frx":4352
            Style           =   1  'Graphical
            TabIndex        =   37
            Top             =   240
            Width           =   1365
         ...
         Begin VB.CommandButton cmdImprime 
            ...
            Height          =   700
            Left            =   5588
            Picture         =   "rProductosIngresados.frx":483E
            Style           =   1  'Graphical
            TabIndex        =   22
            Top             =   240
            Width           =   1365
      ...
      Begin VB.Frame fraCabecera 
         ...
         Begin VB.CommandButton btnBuscar 
            Height          =   315
            Left            =   12270
            Picture         =   "rProductosIngresados.frx":4D17
            Style           =   1  'Graphical
            TabIndex        =   39
            Top             =   330
            Width           =   1305
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.CommandButton btnCancelar 
            Caption         =   "Cancelar(ESC)"
            DisabledPicture =   "rProductosIngresados.frx":7960
            DownPicture     =   "rProductosIngresados.frx":7E24
            Height          =   700
            Left            =   7718
            Picture         =   "rProductosIngresados.frx":8310
            Style           =   1  'Graphical
            TabIndex        =   36
            Top             =   240
            Width           =   1365
         ...
         Begin VB.CommandButton btnImprimirDetallado 
            ...
            Height          =   700
            Left            =   6293
            Picture         =   "rProductosIngresados.frx":87FC
            Style           =   1  'Graphical
            TabIndex        =   4
            Top             =   240
            Width           =   1365
         ...
         Begin VB.CommandButton btnImprimirConsolidado 
            ...
            Height          =   700
            Left            =   4868
            Picture         =   "rProductosIngresados.frx":8CD5
            Style           =   1  'Graphical
            TabIndex        =   3
            Top             =   240
            Width           =   1365
...
If wxFranklin = "*" Then Exit Sub
    ...
    ParteDiario CDate(txtFinicio.Text & " 00:00:01"), _
                CDate(txtFFinal.Text & " 23:59:59"), "/" & mo_cmbFarmacia.BoundText & "/", False, True, False
...
'           mo_AdminReportes.ExportarRecordSetAexcel mrs_Tmp, tabReportes.Caption, lcFiltro, "", Me.hwnd, True, _
'                                                    True
'
'    Else
'        mrs_Tmp.Sort = "nombre"
...
'        RpConsumoItems.Orientation = rptOrientDefault
