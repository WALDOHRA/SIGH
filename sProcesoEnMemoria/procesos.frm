...
'                              End If
        ...
        Case "MAXIMOMONTO"
           ...
           grdHospitalizados.Caption = "Pacientes que están por llegar al MAXIMO MONTO por Fuente Financiamiento"
        Case "EMERGENCIA"
...
'---------------------------------
    ...
    If wxMuestraGrid = "CambioAño" Then
...
Dim ldFechaInicio As Date, ldFechaFinal As Date
   ...
   End With
   '
   Me.grdSinTriaje.Caption = "Pacientes sin TRIAJE hasta: " & ldFechaFinal & " (solo con teléfonos)"
