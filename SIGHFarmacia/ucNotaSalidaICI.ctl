...
Begin VB.UserControl ucNotaSalidaICI 
   ClientHeight    =   5685
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   13050
   ...
   Begin VB.Frame fraSinLote 
      ...
      Begin Threed.SSCommand btnAgregar 
         ...
         _Version        =   262144
         PictureFrames   =   1
         Picture         =   "ucNotaSalidaICI.ctx":0000
         Caption         =   "Agregar"
         PictureAlignment=   9
      End
      Begin UltraGrid.SSUltraGrid grdProductosLotes 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Appearance      =   "ucNotaSalidaICI.ctx":2F8C
   ...
   Begin VB.ComboBox cmbOrden 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "ucNotaSalidaICI.ctx":2FC8
      Left            =   6240
      List            =   "ucNotaSalidaICI.ctx":2FD2
   ...
   Begin UltraGrid.SSUltraGrid grillaBusqueda 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Appearance      =   "ucNotaSalidaICI.ctx":2FEE
      Caption         =   ".."
   End
   ...
   End
End
Attribute VB_Name = "ucNotaSalidaICI"
