...
Begin VB.UserControl ucNotaIngreso 
   ClientHeight    =   5685
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   13050
   ...
   Begin VB.ComboBox cmbOrden 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "ucNotaIngreso.ctx":0000
      Left            =   6240
      List            =   "ucNotaIngreso.ctx":000A
   ...
   Begin UltraGrid.SSUltraGrid grillaBusqueda 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Appearance      =   "ucNotaIngreso.ctx":0026
      Caption         =   ".."
   End
   Begin UltraGrid.SSUltraGrid grdProductos 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Override        =   "ucNotaIngreso.ctx":0062
      Caption         =   "Productos"
   End
   ...
   End
End
Attribute VB_Name = "ucNotaIngreso"
