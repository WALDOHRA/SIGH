...
Private Sub cmdBuscarS_Click()
    ...
    If txtDctoAjuste.Text = "" Then
       ...
       Exit Sub
    End If
    If txtFAjuste.Text = sighcomun.FECHA_VACIA_DMY Then
       MsgBox "Ingrese la Fecha ", vbCritical, Me.Caption
       Exit Sub
    End If
    If txtHajuste.Text = sighcomun.HORA_VACIA_HM Then
...
End If
        ...
        Do While Not oRsSaldosAjuste.EOF
           ...
           oRsSaldosAjuste.MoveNext
        Loop
        If Not mo_ReglasFarmacia.AgregaDatosDeInventario(mo_FarmInventario, oRsSaldosAjuste, oRsSaldosAjuste, 801, "Olidata") = True Then
...
Private Sub Form_Load()
    wxConexionRed = sighcomun.CadenaConexion
