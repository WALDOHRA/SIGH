...
Begin VB.Form labRepTipoAnalisisConRes 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Reporte de Pruebas Registradas con Resultados por Grupos "
   ClientHeight    =   2205
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7800
   Icon            =   "labRepTipoAnalisisConResultados.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   2205
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton btnCancelar 
         ...
         DisabledPicture =   "labRepTipoAnalisisConResultados.frx":0CCA
         DownPicture     =   "labRepTipoAnalisisConResultados.frx":118E
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
         ...
         Height          =   700
         Left            =   3900
         Picture         =   "labRepTipoAnalisisConResultados.frx":167A
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   225
         Width           =   1365
      ...
      Begin VB.CommandButton btnAceptar 
         Caption         =   "Aceptar (F2)"
         DisabledPicture =   "labRepTipoAnalisisConResultados.frx":1B66
         DownPicture     =   "labRepTipoAnalisisConResultados.frx":1FC6
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
         ...
         Height          =   700
         Left            =   2400
         Picture         =   "labRepTipoAnalisisConResultados.frx":243B
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   240
         Width           =   1365
   ...
   Begin VB.Frame fraDatosHistoria 
      ...
      Begin VB.ComboBox cmbGrupo 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "labRepTipoAnalisisConResultados.frx":28B0
         Left            =   1350
         List            =   "labRepTipoAnalisisConResultados.frx":28BA
   ...
   End
End
Attribute VB_Name = "labRepTipoAnalisisConRes"
...
'        Programa: Reporte de tipo de anális por grupos
...
Private Sub btnAceptar_Click()
  ...
  MousePointer = 11
    If lbEsOpenOffice = True Then
        ...
        lcArchivoExcel = App.Path + "\Plantillas\LabRepPruebasRegistradasResultados.ods"
...
'        Fichier = Chemin & "/OpenOffice.ods"
    ...
    Else
        ...
        Set oWorkBookPlantilla = oExcel.Workbooks.Open(App.Path + "\Plantillas\LabRepPruebasRegistradasResultados.xls")
        oWorkBookPlantilla.Worksheets("PruebasConResultados").Copy Before:=oWorkBook.Sheets(1)
    ...
    If lbEsOpenOffice = True Then
        ...
        Call Feuille.getcellbyposition(1, 2).setFormula("Fecha Inicio " & FI & "  -  Fecha Fin: " & FF)
    Else
        'Inicio de Impresion
        oWorkSheet.Cells(2, 2).Value = "GRUPO " & UCase(cmbGrupo.Text)
        oWorkSheet.Cells(3, 2).Value = "Fecha Inicio " & FI & "  -  Fecha Fin: " & FF
    End If
  iFila = 6
  iCol = 2
  ...
  Do While Not rsReporte.EOF
    ...
    Else
        ...
        'TCant1 = mo_ReglasLaboratorio.CuentaPruebasConResultados(rsReporte!idProducto, FI, FF)
    End If
    TCant1 = mo_ReglasLaboratorio.CuentaPruebasConResultados(rsReporte!idProducto, Trim(rsReporte!codigoCPT), FI, FF)
    If lbEsOpenOffice = True Then
...
Private Sub cmbGrupo_Click()
  ...
  'Set rs = mo_ReglasLaboratorio.SacarPruebasPorGrupo(Left(Right(cmbGrupo.Text, 4), 3))
