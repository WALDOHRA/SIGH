...
Begin VB.Form LabIngresos 
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton btnAceptar 
         Caption         =   "Aceptar (F2)"
         DisabledPicture =   "LabIngresos.frx":0CCA
         DownPicture     =   "LabIngresos.frx":112A
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
      ...
      Begin VB.CommandButton btnCancelar 
         ...
         DisabledPicture =   "LabIngresos.frx":1A14
         DownPicture     =   "LabIngresos.frx":1ED8
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
...
'        Programa: Mantenimiento de Ingresos de Insumos
...
Function ValidarDatosObligatorios() As Boolean
  ...
  ms_MensajeError = ""
  If txtNdocumento.Text = "" Then ms_MensajeError = ms_MensajeError & "- Registre el Número de Documento." & Chr(13)
  If cmbResponsable.Text = "" Then ms_MensajeError = ms_MensajeError & "- Elija el Responsable que Recepciona." & Chr(13)
  ...
  Select Case mi_Opcion
    Case sghAgregar, sghModificar
      ...
      If Not (rsProductos.EOF And rsProductos.BOF) Then
        ...
        Loop
      End If
      If Me.ucProductos.DevuelveTotalPagar <= 0 Then ms_MensajeError = ms_MensajeError & "- Agregue insumos a ingresar (Importe total es S/. 0.00)." & Chr(13)
  End Select
...
Function AgregarDatos() As Boolean
  AgregarDatos = mo_ReglasLaboratorio.labMovimientoIngresosAgregar(oDOLabMovimiento, oDOLabMovimientoIngresos, rsProductos, mo_lnIdTablaLISTBARITEMS, mo_lcNombrePc)
  ms_MensajeError = mo_ReglasLaboratorio.MensajeError
  ml_IdMovimiento = oDOLabMovimiento.IdMovimiento
End Function

Function ModificarDatos() As Boolean
  ModificarDatos = mo_ReglasLaboratorio.LabMovimientoIngresosModificar(oDOLabMovimiento, oDOLabMovimientoIngresos, rsProductos, mo_lnIdTablaLISTBARITEMS, mo_lcNombrePc)
  ms_MensajeError = mo_ReglasLaboratorio.MensajeError
End Function

Function EliminarDatos() As Boolean
  EliminarDatos = mo_ReglasLaboratorio.LabMovimientoIngresosAnular(oDOLabMovimiento, oDOLabMovimientoIngresos, rsProductos, mo_lnIdTablaLISTBARITEMS, mo_lcNombrePc)
  ms_MensajeError = mo_ReglasLaboratorio.MensajeError
End Function
...
'  MsgBox 1
  ...
  'mo_cmbIdPuntoCarga.BoundText = ucingresos.
  Select Case mi_Opcion
    Case sghAgregar
      Me.Caption = "Agregar Ingreso de Insumos"
      mo_cmbIdPuntoCarga.BoundText = IdPuntoCarga
      mo_Formulario.HabilitarDeshabilitar cmbIdPuntoDeCarga, False
    Case sghModificar
      Me.Caption = "Modificar Ingreso de Insumos"
    Case sghConsultar
      Me.Caption = "Consultar Ingreso de Insumos"
    Case sghEliminar
      Me.Caption = "Eliminar Ingreso de Insumos"
  End Select
...
Sub CargarDatosALosControles()
  ...
  '
  Set oDOLabMovimientoIngresos = mo_ReglasLaboratorio.LabMovimientoIngresosSeleccionarPorId(ml_IdMovimiento)
  txtNdocumento.Text = oDOLabMovimientoIngresos.nroDocumento
  mo_cmbResponsable.BoundText = oDOLabMovimientoIngresos.IdPersonaRecepciona
...
Private Sub txtNdocumento_GotFocus()
  SeleccionaTexto txtNdocumento
End Sub
