VERSION 5.00
Begin VB.Form HTransferencia 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Transferencia Hospitalaria por Departamentos y/o Servicios"
   ClientHeight    =   5760
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   7335
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton btnCancelar 
         ...
         DisabledPicture =   "HTransferencia.frx":0000
         DownPicture     =   "HTransferencia.frx":04C4
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
         ...
         Height          =   700
         Left            =   3750
         Picture         =   "HTransferencia.frx":09B0
         Style           =   1  'Graphical
         TabIndex        =   24
         Top             =   210
         Width           =   1365
      ...
      Begin VB.CommandButton btnAceptar 
         Caption         =   "Aceptar (F2)"
         DisabledPicture =   "HTransferencia.frx":0E9C
         DownPicture     =   "HTransferencia.frx":12FC
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
         ...
         Height          =   700
         Left            =   2220
         Picture         =   "HTransferencia.frx":1771
         Style           =   1  'Graphical
         TabIndex        =   23
         Top             =   225
         Width           =   1365
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbTipoRep 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "HTransferencia.frx":1BE6
         Left            =   1230
         List            =   "HTransferencia.frx":1BF6
         Style           =   2  'Dropdown List
         TabIndex        =   6
         Top             =   600
         Width           =   5850
      ...
      Begin VB.ComboBox cmbConsiderar 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "HTransferencia.frx":1C60
         Left            =   3645
         List            =   "HTransferencia.frx":1C6A
         Style           =   2  'Dropdown List
         TabIndex        =   4
         Top             =   195
         Width           =   3435
      ...
      Begin VB.ComboBox cmbAnio 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "HTransferencia.frx":1CC0
         Left            =   1245
         List            =   "HTransferencia.frx":1CC2
         Style           =   2  'Dropdown List
         TabIndex        =   3
         Top             =   195
         Width           =   1215
   ...
   End
End
Attribute VB_Name = "HTransferencia"
...
'        Programa: Transferencia entre servicios hospitalarios
...
Sub btnAceptar_Click()
    If ValidaDatosObligatorios Then
        Me.MousePointer = 11
        Dim oRptTransferencia As New RptHTransferencia
        oRptTransferencia.Anio = Val(cmbAnio.Text)
        oRptTransferencia.TransferenciaQueVan = IIf(cmbConsiderar.ListIndex = 0, True, False)
        oRptTransferencia.TipoReporte = cmbTipoRep.ListIndex
        oRptTransferencia.idDepartamento1 = IIf(mo_cmbIdDepartamento1.BoundText = "", 0, mo_cmbIdDepartamento1.BoundText)
        oRptTransferencia.idEspecialidad1 = IIf(mo_cmbIdEspecialidad1.BoundText = "", 0, mo_cmbIdEspecialidad1.BoundText)
        oRptTransferencia.idServicio1 = IIf(mo_cmbIdServicio1.BoundText = "", 0, mo_cmbIdServicio1.BoundText)
        oRptTransferencia.idDepartamento2 = IIf(mo_cmbIdDepartamento2.BoundText = "", 0, mo_cmbIdDepartamento2.BoundText)
        oRptTransferencia.idEspecialidad2 = IIf(mo_cmbIdEspecialidad2.BoundText = "", 0, mo_cmbIdEspecialidad2.BoundText)
        oRptTransferencia.idServicio2 = IIf(mo_cmbIdServicio2.BoundText = "", 0, mo_cmbIdServicio2.BoundText)
        oRptTransferencia.Titulo = ml_Titulo
        oRptTransferencia.TextoDelFiltro = ml_TextoDelFiltro
        oRptTransferencia.CrearReporteDetallado Me.hwnd
        Me.MousePointer = 1
    End If
End Sub
...
Function ValidaDatosObligatorios() As Boolean
    ...
    Case 0
        ml_Titulo = "TRANSFERENCIA HOSPITALARIA"
    Case 1
        ml_Titulo = "TRANSFERENCIA HOSPITALARIA CONSOLIDANDO POR DEPARTAMENTOS"
    Case 2    'por un Servicio
        ml_Titulo = "TRANSFERENCIA HOSPITALARIA POR ESPECIALIDAD"
    ...
    Case 3    'por 2 Especialidades
        ml_Titulo = "TRANSFERENCIA HOSPITALARIA CONSOLIDANDO DOS SERVICIOS"
        If cmbIdDepartamento1.Text = "" Then
