...
Begin VB.Form HMorbCE 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Morbilidad de Consultorios Externos por Departamentos y/o Servicios"
   ClientHeight    =   6975
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   13395
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton btnCancelar 
         ...
         DisabledPicture =   "HMorbCE.frx":0000
         DownPicture     =   "HMorbCE.frx":04C4
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
      ...
      Begin VB.CommandButton btnAceptar 
         Caption         =   "Aceptar (F2)"
         DisabledPicture =   "HMorbCE.frx":0E9C
         DownPicture     =   "HMorbCE.frx":12FC
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame6 
         ...
         Begin VB.ComboBox cmbCol2 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "HMorbCE.frx":1BE6
            Left            =   3345
            List            =   "HMorbCE.frx":1BF3
         ...
         Begin VB.ComboBox cmbCol1 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "HMorbCE.frx":1C0A
            Left            =   3345
            List            =   "HMorbCE.frx":1C17
            Style           =   2  'Dropdown List
            TabIndex        =   62
            Top             =   240
            Width           =   1530
         ...
         Begin VB.ComboBox cmbCol4 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "HMorbCE.frx":1C2E
            Left            =   3345
            List            =   "HMorbCE.frx":1C3B
            Style           =   2  'Dropdown List
            TabIndex        =   59
            Top             =   1410
            Width           =   1530
         ...
         Begin VB.ComboBox cmbCol3 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "HMorbCE.frx":1C52
            Left            =   3345
            List            =   "HMorbCE.frx":1C5F
            Style           =   2  'Dropdown List
            TabIndex        =   57
            Top             =   1020
            Width           =   1530
         ...
         Begin VB.ComboBox cmbCol6 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "HMorbCE.frx":1C76
            Left            =   3330
            List            =   "HMorbCE.frx":1C83
            Style           =   2  'Dropdown List
            TabIndex        =   54
            Top             =   2175
            Width           =   1530
         ...
         Begin VB.ComboBox cmbCol5 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "HMorbCE.frx":1C9A
            Left            =   3330
            List            =   "HMorbCE.frx":1CA7
            Style           =   2  'Dropdown List
            TabIndex        =   51
            Top             =   1785
            Width           =   1530
         ...
         Begin VB.ComboBox cmbCol8 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "HMorbCE.frx":1CBE
            Left            =   3315
            List            =   "HMorbCE.frx":1CCB
            Style           =   2  'Dropdown List
            TabIndex        =   48
            Top             =   2955
            Width           =   1530
         ...
         Begin VB.ComboBox cmbCol7 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "HMorbCE.frx":1CE2
            Left            =   3315
            List            =   "HMorbCE.frx":1CEF
            Style           =   2  'Dropdown List
            TabIndex        =   45
            Top             =   2565
            Width           =   1530
      ...
      Begin VB.ComboBox cmbDiagnosticos 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "HMorbCE.frx":1D06
         Left            =   1425
         List            =   "HMorbCE.frx":1D10
         Style           =   2  'Dropdown List
         TabIndex        =   37
         Top             =   720
         Width           =   1875
      ...
      Begin VB.ComboBox cmbDistrito 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "HMorbCE.frx":1D25
         Left            =   1440
         List            =   "HMorbCE.frx":1D2F
         Style           =   2  'Dropdown List
         TabIndex        =   27
         Top             =   1365
         Width           =   1875
      ...
      Begin VB.ComboBox cmbTipoRep 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "HMorbCE.frx":1D44
         Left            =   7290
         List            =   "HMorbCE.frx":1D54
         Style           =   2  'Dropdown List
         TabIndex        =   4
         Top             =   1980
         Width           =   5790
      ...
      Begin VB.ComboBox cmbSexo 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "HMorbCE.frx":1DC5
         Left            =   6930
         List            =   "HMorbCE.frx":1DD2
         Style           =   2  'Dropdown List
         TabIndex        =   3
         Top             =   180
         Width           =   1785
...
'        Programa: Morbilidad Consulta Externa
...
Sub btnAceptar_Click()
    If ValidaDatosObligatorios Then
        Me.MousePointer = 11
        Dim oRptMortalidad As New RptHMorbCE
...
Function ValidaDatosObligatorios() As Boolean
    ...
    ml_TextoDelFiltro = "FILTROS:   (Solo Dx Definitivos)  F.Atención: (" & txtFechaInicio.Text & " hasta " & txtFechaFin.Text & ")"
    ...
    Case 0
        ml_Titulo = "MORBILIDAD DE CONSULTORIOS EXTERNOS"
    Case 1
        ml_Titulo = "MORBILIDAD DE CONSULTORIOS EXTERNOS POR DEPARTAMENTO"
    ...
    Case 2    'por un Servicio
        ml_Titulo = "MORBILIDAD DE CONSULTORIOS EXTERNOS POR ESPECIALIDAD"
        If cmbIdDepartamento1.Text = "" Then
           sMensaje = sMensaje + "Por favor elija el Departamento" + Chr(13)
        End If
    ...
    Case 3    'por 2 Especialidades
        ml_Titulo = "MORBILIDAD DE CONSULTORIOS EXTERNOS CONSOLIDANDO DOS CONSULTORIOS"
        If cmbIdDepartamento1.Text = "" Then
           sMensaje = sMensaje + "Por favor elija el Departamento (para el primer Consultorio)" + Chr(13)
        End If
        If cmbIdEspecialidad1.Text = "" Then
           sMensaje = sMensaje + "Por favor elija la Especialidad (para el primer Consultorio)" + Chr(13)
        End If
        If cmbIdServicio1.Text = "" Then
           sMensaje = sMensaje + "Por favor elija el Servicio (para el primer Consultorio)" + Chr(13)
        End If
        If cmbIdDepartamento2.Text = "" Then
           sMensaje = sMensaje + "Por favor elija el Departamento (para  el segundo Consultorio)" + Chr(13)
        End If
        If cmbIdEspecialidad2.Text = "" Then
           sMensaje = sMensaje + "Por favor elija la Especialidad (para  el segundo Consultorio)" + Chr(13)
        End If
        If cmbIdServicio2.Text = "" Then
           sMensaje = sMensaje + "Por favor elija el Servicio (para el segundo Consultorio)" + Chr(13)
        End If
        ml_TextoDelFiltro = ml_TextoDelFiltro & ",    Consultorio1: (" & cmbIdDepartamento1.Text & ")/(" & cmbIdEspecialidad1.Text & ")/(" & cmbIdServicio1.Text & "),     Consultorio2: (" & cmbIdDepartamento2.Text & ")/(" & cmbIdEspecialidad2.Text & ")/(" & cmbIdServicio2.Text & ")"
    End Select
    If sMensaje <> "" Then
...
Private Sub cmbIdEspecialidad1_Click()
    ...
    Set mo_cmbIdServicio1.RowSource = mo_ReglasFacturacion.ServiciosSeleccionarCEPorEspecialidad(Val(mo_cmbIdEspecialidad1.BoundText))
...
Private Sub cmbIdEspecialidad2_Click()
    ...
    Set mo_cmbIdServicio2.RowSource = mo_ReglasFacturacion.ServiciosSeleccionarCEPorEspecialidad(Val(mo_cmbIdEspecialidad2.BoundText))
End Sub
