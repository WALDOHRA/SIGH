...
Begin VB.Form EmergAuditoria 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Auditoria Emergencia"
   ClientHeight    =   3105
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9225
   Icon            =   "EmergAuditoria.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Frame fraDatosHistoria 
      ...
      Begin VB.CheckBox chkExcel 
         ...
         Height          =   315
         Left            =   7920
         Picture         =   "EmergAuditoria.frx":0CCA
         TabIndex        =   10
         Top             =   660
         Width           =   1125
      End
      Begin VB.ComboBox cmbUsuario 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "EmergAuditoria.frx":0FDC
         Left            =   1470
         List            =   "EmergAuditoria.frx":0FE6
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton btnAceptar 
         Caption         =   "Aceptar (F2)"
         DisabledPicture =   "EmergAuditoria.frx":1002
         DownPicture     =   "EmergAuditoria.frx":1462
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
         ...
         Height          =   700
         Left            =   3210
         Picture         =   "EmergAuditoria.frx":18D7
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   240
         Width           =   1365
      ...
      Begin VB.CommandButton btnCancelar 
         ...
         DisabledPicture =   "EmergAuditoria.frx":1D4C
         DownPicture     =   "EmergAuditoria.frx":2210
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
         ...
         Height          =   700
         Left            =   4740
         Picture         =   "EmergAuditoria.frx":26FC
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   225
         Width           =   1365
   ...
   End
End
Attribute VB_Name = "EmergAuditoria"
...
'        Programa: Auditoría para Emergencia
...
Function ValidaDatosObligatorios() As Boolean
    sMensaje = ""
    ml_TextoDelFiltro = "FILTROS:    F.Movimiento: (" & txtFdesde.Text & "   al " & txtFhasta.Text & ")     Usuario: " & cmbUsuario.Text
    ...
    If Me.txtHrInicio = SIGHEntidades.HORA_VACIA_HM Then
        sMensaje = "Ingrese la hora movimiento inicial"
    Else
