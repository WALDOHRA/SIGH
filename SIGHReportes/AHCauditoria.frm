...
Begin VB.Form AHCauditoria 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Auditoria Archivos Clínicos"
   ClientHeight    =   3105
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9225
   Icon            =   "AHCauditoria.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Frame fraDatosHistoria 
      ...
      Begin VB.ComboBox cmbUsuario 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "AHCauditoria.frx":0FDC
         Left            =   1500
         List            =   "AHCauditoria.frx":0FE6
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton btnAceptar 
         Caption         =   "Aceptar (F2)"
         DisabledPicture =   "AHCauditoria.frx":1002
         DownPicture     =   "AHCauditoria.frx":1462
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
      ...
      Begin VB.CommandButton btnCancelar 
         ...
         DisabledPicture =   "AHCauditoria.frx":1D4C
         DownPicture     =   "AHCauditoria.frx":2210
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "AHCauditoria"
