...
Begin VB.Form EFospolis 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Convenio MINSA - FOSPOLIS"
   ClientHeight    =   2235
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   5715
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton btnAceptar 
         Caption         =   "Aceptar (F2)"
         DisabledPicture =   "EFospolis.frx":0000
         DownPicture     =   "EFospolis.frx":0460
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
      ...
      Begin VB.CommandButton btnCancelar 
         ...
         DisabledPicture =   "EFospolis.frx":0D4A
         DownPicture     =   "EFospolis.frx":120E
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
...
Private Sub btnAceptar_Click()
    If Me.txtFechaInicio = SIGHEntidades.FECHA_VACIA_DMY Then
        MsgBox "Ingrese la fecha de consumo inicial", vbInformation, Me.Caption
        Exit Sub
    Else
        If Not SIGHEntidades.EsFecha(Me.txtFechaInicio, "DD/MM/AAAA") Then
            MsgBox "La fecha de consumo inicial no tiene el formato correcto", vbInformation, Me.Caption
            Exit Sub
        End If
    End If
    
    If Me.txtFechaFin = SIGHEntidades.FECHA_VACIA_DMY Then
        MsgBox "Ingrese la fecha de consumo final", vbInformation, Me.Caption
        Exit Sub
    Else
        If Not SIGHEntidades.EsFecha(Me.txtFechaFin, "DD/MM/AAAA") Then
            MsgBox "La fecha de consumo final no tiene el formato correcto", vbInformation, Me.Caption
            Exit Sub
        End If
    End If
    ...
    Me.MousePointer = 11
        Dim oRptFospolis As New RptEFospolis
        oRptFospolis.FechaInicio = txtFechaInicio.Text
        oRptFospolis.FechaFin = txtFechaFin.Text
        oRptFospolis.TextoDelFiltro = "Filtros:     F.Autorización: (" & txtFechaInicio.Text & " - " & txtFechaFin.Text & ")"
        oRptFospolis.CrearReporte_excel Me.hwnd
    Me.MousePointer = 1
End Sub
