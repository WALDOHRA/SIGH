VERSION 5.00
Begin VB.Form HCamaDias 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Días Camas por Departamentos y/o Servicios"
   ClientHeight    =   5760
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   7260
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton btnCancelar 
         ...
         DisabledPicture =   "HCamaDias.frx":0000
         DownPicture     =   "HCamaDias.frx":04C4
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
      ...
      Begin VB.CommandButton btnAceptar 
         Caption         =   "Aceptar (F2)"
         DisabledPicture =   "HCamaDias.frx":0E9C
         DownPicture     =   "HCamaDias.frx":12FC
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbTipoRep 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "HCamaDias.frx":1BE6
         Left            =   1230
         List            =   "HCamaDias.frx":1BF6
         Style           =   2  'Dropdown List
         TabIndex        =   6
         Top             =   600
         Width           =   5850
      ...
      Begin VB.ComboBox cmbConsiderar 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "HCamaDias.frx":1C60
         Left            =   4050
         List            =   "HCamaDias.frx":1C6A
         Style           =   2  'Dropdown List
         TabIndex        =   4
         Top             =   225
         Width           =   3030
      ...
      Begin VB.ComboBox cmbAnio 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "HCamaDias.frx":1C8B
         Left            =   1230
         List            =   "HCamaDias.frx":1C8D
         Style           =   2  'Dropdown List
         TabIndex        =   3
         Top             =   195
         Width           =   1215
...
Sub btnAceptar_Click()
    If ValidaDatosObligatorios Then
        Me.MousePointer = 11
        Dim oRptCamas As New RptHCamaDias
        oRptCamas.Anio = Val(cmbAnio.Text)
        oRptCamas.SoloHospit = IIf(cmbConsiderar.ListIndex = 0, True, False)
        oRptCamas.TipoReporte = cmbTipoRep.ListIndex
        oRptCamas.idDepartamento1 = IIf(mo_cmbIdDepartamento1.BoundText = "", 0, mo_cmbIdDepartamento1.BoundText)
        oRptCamas.idEspecialidad1 = IIf(mo_cmbIdEspecialidad1.BoundText = "", 0, mo_cmbIdEspecialidad1.BoundText)
        oRptCamas.idServicio1 = IIf(mo_cmbIdServicio1.BoundText = "", 0, mo_cmbIdServicio1.BoundText)
        oRptCamas.idDepartamento2 = IIf(mo_cmbIdDepartamento2.BoundText = "", 0, mo_cmbIdDepartamento2.BoundText)
        oRptCamas.idEspecialidad2 = IIf(mo_cmbIdEspecialidad2.BoundText = "", 0, mo_cmbIdEspecialidad2.BoundText)
        oRptCamas.idServicio2 = IIf(mo_cmbIdServicio2.BoundText = "", 0, mo_cmbIdServicio2.BoundText)
        oRptCamas.Titulo = ml_Titulo
        oRptCamas.TextoDelFiltro = ml_TextoDelFiltro
        oRptCamas.CrearReporteDetallado Me.hwnd
        Me.MousePointer = 1
    End If
End Sub
...
Function ValidaDatosObligatorios() As Boolean
    ...
    sMensaje = ""
    ml_TextoDelFiltro = "(N°veces q se usó en el mes por c/Servicio * N° días del mes) FILTROS:   Año: " & cmbAnio.Text & ",   se consideró: " & cmbConsiderar.Text
    Select Case cmbTipoRep.ListIndex
    Case 0
        ml_Titulo = "DIAS CAMAS "
    Case 1
        ml_Titulo = "DIAS CAMAS CONSOLIDANDO POR DEPARTAMENTOS"
    Case 2    'por un Servicio
        ml_Titulo = "DIAS CAMAS POR ESPECIALIDAD"
    ...
    Case 3    'por 2 Especialidades
        ml_Titulo = "DIAS CAMAS CONSOLIDANDO DOS SERVICIOS"
        If cmbIdDepartamento1.Text = "" Then
