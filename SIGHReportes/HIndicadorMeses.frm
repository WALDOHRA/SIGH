VERSION 5.00
Begin VB.Form HIndicadorMeses 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Indicadores Hospitalarios por Meses por Departamentos y/o Servicios"
   ClientHeight    =   6180
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   7335
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton btnCancelar 
         ...
         DisabledPicture =   "HIndicadorMeses.frx":0000
         DownPicture     =   "HIndicadorMeses.frx":04C4
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
         ...
         Height          =   700
         Left            =   3750
         Picture         =   "HIndicadorMeses.frx":09B0
         Style           =   1  'Graphical
         TabIndex        =   24
         Top             =   210
         Width           =   1365
      ...
      Begin VB.CommandButton btnAceptar 
         Caption         =   "Aceptar (F2)"
         DisabledPicture =   "HIndicadorMeses.frx":0E9C
         DownPicture     =   "HIndicadorMeses.frx":12FC
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
         ...
         Height          =   700
         Left            =   2220
         Picture         =   "HIndicadorMeses.frx":1771
         Style           =   1  'Graphical
         TabIndex        =   23
         Top             =   225
         Width           =   1365
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbTipoRep 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "HIndicadorMeses.frx":1BE6
         Left            =   1215
         List            =   "HIndicadorMeses.frx":1BF6
         Style           =   2  'Dropdown List
         TabIndex        =   6
         Top             =   1065
         Width           =   5820
      ...
      Begin VB.ComboBox cmbConsiderar 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "HIndicadorMeses.frx":1C60
         Left            =   1215
         List            =   "HIndicadorMeses.frx":1C6A
         Style           =   2  'Dropdown List
         TabIndex        =   4
         Top             =   645
         Width           =   5835
      ...
      Begin VB.ComboBox cmbAnio 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "HIndicadorMeses.frx":1CA2
         Left            =   1245
         List            =   "HIndicadorMeses.frx":1CA4
         Style           =   2  'Dropdown List
         TabIndex        =   3
         Top             =   195
         Width           =   1215
   ...
   End
End
Attribute VB_Name = "HIndicadorMeses"
...
Sub btnAceptar_Click()
    If ValidaDatosObligatorios Then
        Me.MousePointer = 11
        Dim oRptIndicador As New RptHIndicadorMeses
