VERSION 5.00
Begin VB.Form HCamas 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Camas por Departamentos y/o Servicios"
   ClientHeight    =   5760
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   7260
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton btnCancelar 
         ...
         DisabledPicture =   "HCamas.frx":0000
         DownPicture     =   "HCamas.frx":04C4
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
      ...
      Begin VB.CommandButton btnAceptar 
         Caption         =   "Aceptar (F2)"
         DisabledPicture =   "HCamas.frx":0E9C
         DownPicture     =   "HCamas.frx":12FC
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbTipoRep 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "HCamas.frx":1BE6
         Left            =   1230
         List            =   "HCamas.frx":1BF6
         Style           =   2  'Dropdown List
         TabIndex        =   6
         Top             =   600
         Width           =   5850
      ...
      Begin VB.ComboBox cmbConsiderar 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "HCamas.frx":1C60
         Left            =   4035
         List            =   "HCamas.frx":1C6A
         Style           =   2  'Dropdown List
         TabIndex        =   4
         Top             =   225
         Width           =   3030
      ...
      Begin VB.ComboBox cmbAnio 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "HCamas.frx":1C8B
         Left            =   1245
         List            =   "HCamas.frx":1C8D
         Style           =   2  'Dropdown List
         TabIndex        =   3
         Top             =   195
         Width           =   1215
...
Sub btnAceptar_Click()
    If ValidaDatosObligatorios Then
        Me.MousePointer = 11
        Dim oRptCamas As New RptHCamas
...
Function ValidaDatosObligatorios() As Boolean
    ...
    sMensaje = ""
    ml_TextoDelFiltro = "(N°veces q se usó en el mes por c/Servicio)  FILTROS:   Año: " & cmbAnio.Text & ",   se consideró: " & cmbConsiderar.Text
    Select Case cmbTipoRep.ListIndex
    Case 0
        ml_Titulo = "CAMAS"
    Case 1
        ml_Titulo = "CAMAS CONSOLIDANDO POR DEPARTAMENTOS"
    Case 2    'por un Servicio
        ml_Titulo = "CAMAS POR ESPECIALIDAD"
    ...
    Case 3    'por 2 Especialidades
        ml_Titulo = "CAMAS CONSOLIDANDO DOS SERVICIOS"
        If cmbIdDepartamento1.Text = "" Then
