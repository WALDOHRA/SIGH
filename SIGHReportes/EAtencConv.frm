...
Begin VB.Form EAtencConv 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Atenciones por Convenio"
   ClientHeight    =   2235
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   5715
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton btnAceptar 
         Caption         =   "Aceptar (F2)"
         DisabledPicture =   "EAtencConv.frx":0000
         DownPicture     =   "EAtencConv.frx":0460
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
      ...
      Begin VB.CommandButton btnCancelar 
         ...
         DisabledPicture =   "EAtencConv.frx":0D4A
         DownPicture     =   "EAtencConv.frx":120E
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Label Label2 
         AutoSize        =   -1  'True
         Caption         =   "Fecha de Sesión Inicial"
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
...
Private Sub btnAceptar_Click()
    ...
    Me.MousePointer = 11
        Dim oRptConv As New RptEAtencConv
        oRptConv.FechaInicio = txtFechaInicio.Text
        oRptConv.FechaFin = txtFechaFin.Text
        oRptConv.TextoDelFiltro = "Filtros:     F.Sesiones: (" & txtFechaInicio.Text & " - " & txtFechaFin.Text & ")"
        oRptConv.CrearReporte_excel Me.hwnd
    Me.MousePointer = 1
End Sub
