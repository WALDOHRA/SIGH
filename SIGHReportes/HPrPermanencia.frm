VERSION 5.00
Begin VB.Form HPrPermanencia 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Promedio Permanencia Hospitalaria por Departamentos y/o Servicios"
   ClientHeight    =   5760
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   7335
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton btnCancelar 
         ...
         DisabledPicture =   "HPrPermanencia.frx":0000
         DownPicture     =   "HPrPermanencia.frx":04C4
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
         ...
         Height          =   700
         Left            =   3750
         Picture         =   "HPrPermanencia.frx":09B0
         Style           =   1  'Graphical
         TabIndex        =   24
         Top             =   210
         Width           =   1365
      ...
      Begin VB.CommandButton btnAceptar 
         Caption         =   "Aceptar (F2)"
         DisabledPicture =   "HPrPermanencia.frx":0E9C
         DownPicture     =   "HPrPermanencia.frx":12FC
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
         ...
         Height          =   700
         Left            =   2220
         Picture         =   "HPrPermanencia.frx":1771
         Style           =   1  'Graphical
         TabIndex        =   23
         Top             =   225
         Width           =   1365
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbTipoRep 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "HPrPermanencia.frx":1BE6
         Left            =   1230
         List            =   "HPrPermanencia.frx":1BF6
         Style           =   2  'Dropdown List
         TabIndex        =   6
         Top             =   600
         Width           =   5850
      ...
      Begin VB.ComboBox cmbConsiderar 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "HPrPermanencia.frx":1C60
         Left            =   4215
         List            =   "HPrPermanencia.frx":1C6A
         Style           =   2  'Dropdown List
         TabIndex        =   4
         Top             =   180
         Width           =   2865
      ...
      Begin VB.ComboBox cmbAnio 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "HPrPermanencia.frx":1CA2
         Left            =   1245
         List            =   "HPrPermanencia.frx":1CA4
         Style           =   2  'Dropdown List
         TabIndex        =   3
         Top             =   195
         Width           =   1215
   ...
   End
End
Attribute VB_Name = "HPrPermanencia"
...
'        Programa: Promedio de Permanencia en Hospitalización
...
Sub btnAceptar_Click()
    If ValidaDatosObligatorios Then
        Me.MousePointer = 11
        Dim oRptPromedioPermanencia As New RptHPrPermanencia
        oRptPromedioPermanencia.Anio = Val(cmbAnio.Text)
        oRptPromedioPermanencia.FechaAltaMedica = IIf(cmbConsiderar.ListIndex = 0, True, False)
        oRptPromedioPermanencia.TipoReporte = cmbTipoRep.ListIndex
        oRptPromedioPermanencia.idDepartamento1 = IIf(mo_cmbIdDepartamento1.BoundText = "", 0, mo_cmbIdDepartamento1.BoundText)
        oRptPromedioPermanencia.idEspecialidad1 = IIf(mo_cmbIdEspecialidad1.BoundText = "", 0, mo_cmbIdEspecialidad1.BoundText)
        oRptPromedioPermanencia.idServicio1 = IIf(mo_cmbIdServicio1.BoundText = "", 0, mo_cmbIdServicio1.BoundText)
        oRptPromedioPermanencia.idDepartamento2 = IIf(mo_cmbIdDepartamento2.BoundText = "", 0, mo_cmbIdDepartamento2.BoundText)
        oRptPromedioPermanencia.idEspecialidad2 = IIf(mo_cmbIdEspecialidad2.BoundText = "", 0, mo_cmbIdEspecialidad2.BoundText)
        oRptPromedioPermanencia.idServicio2 = IIf(mo_cmbIdServicio2.BoundText = "", 0, mo_cmbIdServicio2.BoundText)
        oRptPromedioPermanencia.Titulo = ml_Titulo
        oRptPromedioPermanencia.TextoDelFiltro = ml_TextoDelFiltro
        oRptPromedioPermanencia.CrearReporte Me.hwnd
        Me.MousePointer = 1
    End If
End Sub
...
Function ValidaDatosObligatorios() As Boolean
    ...
    sMensaje = ""
    ml_TextoDelFiltro = "(N° días entre FechaHoraEgreso-FechaHoraIngreso/N°Egresos)  FILTROS:   Año: " & cmbAnio.Text & ",   se consideró: " & cmbConsiderar.Text
    Select Case cmbTipoRep.ListIndex
    Case 0
        ml_Titulo = "PROMEDIO ESTANCIA HOSPITALARIA"
    Case 1
        ml_Titulo = "PROMEDIO ESTANCIA HOSPITALARIA CONSOLIDANDO POR DEPARTAMENTOS"
    Case 2    'por un Servicio
        ml_Titulo = "PROMEDIO ESTANCIA HOSPITALARIA POR ESPECIALIDAD"
    ...
    Case 3    'por 2 Especialidades
        ml_Titulo = "PROMEDIO ESTANCIA HOSPITALARIA CONSOLIDANDO DOS SERVICIOS"
        If cmbIdDepartamento1.Text = "" Then
