VERSION 5.00
Begin VB.Form HEstanciaH 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Estancia Hospitalaria por Departamentos y/o Servicios"
   ClientHeight    =   5760
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   7335
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton btnCancelar 
         ...
         DisabledPicture =   "HEstanciaH.frx":0000
         DownPicture     =   "HEstanciaH.frx":04C4
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
      ...
      Begin VB.CommandButton btnAceptar 
         Caption         =   "Aceptar (F2)"
         DisabledPicture =   "HEstanciaH.frx":0E9C
         DownPicture     =   "HEstanciaH.frx":12FC
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbTipoRep 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "HEstanciaH.frx":1BE6
         Left            =   1230
         List            =   "HEstanciaH.frx":1BF6
         Style           =   2  'Dropdown List
         TabIndex        =   6
         Top             =   600
         Width           =   5850
      ...
      Begin VB.ComboBox cmbConsiderar 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "HEstanciaH.frx":1C60
         Left            =   4215
         List            =   "HEstanciaH.frx":1C6A
         Style           =   2  'Dropdown List
         TabIndex        =   4
         Top             =   195
         Width           =   2865
      ...
      Begin VB.ComboBox cmbAnio 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "HEstanciaH.frx":1CA2
         Left            =   1245
         List            =   "HEstanciaH.frx":1CA4
         Style           =   2  'Dropdown List
         TabIndex        =   3
         Top             =   195
         Width           =   1215
...
Sub btnAceptar_Click()
    If ValidaDatosObligatorios Then
        Me.MousePointer = 11
        Dim oRptEstanciaHosp As New RptHEstanciaH
        oRptEstanciaHosp.Anio = Val(cmbAnio.Text)
        oRptEstanciaHosp.FechaAltaMedica = IIf(cmbConsiderar.ListIndex = 0, True, False)
        oRptEstanciaHosp.TipoReporte = cmbTipoRep.ListIndex
        oRptEstanciaHosp.idDepartamento1 = IIf(mo_cmbIdDepartamento1.BoundText = "", 0, mo_cmbIdDepartamento1.BoundText)
        oRptEstanciaHosp.idEspecialidad1 = IIf(mo_cmbIdEspecialidad1.BoundText = "", 0, mo_cmbIdEspecialidad1.BoundText)
        oRptEstanciaHosp.idServicio1 = IIf(mo_cmbIdServicio1.BoundText = "", 0, mo_cmbIdServicio1.BoundText)
        oRptEstanciaHosp.idDepartamento2 = IIf(mo_cmbIdDepartamento2.BoundText = "", 0, mo_cmbIdDepartamento2.BoundText)
        oRptEstanciaHosp.idEspecialidad2 = IIf(mo_cmbIdEspecialidad2.BoundText = "", 0, mo_cmbIdEspecialidad2.BoundText)
        oRptEstanciaHosp.idServicio2 = IIf(mo_cmbIdServicio2.BoundText = "", 0, mo_cmbIdServicio2.BoundText)
        oRptEstanciaHosp.Titulo = ml_Titulo
        oRptEstanciaHosp.TextoDelFiltro = ml_TextoDelFiltro
        oRptEstanciaHosp.CrearReporte Me.hwnd
        Me.MousePointer = 1
    End If
End Sub
...
Function ValidaDatosObligatorios() As Boolean
    ...
    sMensaje = ""
    ml_TextoDelFiltro = "(N° días entre FechaHoraEgreso - FechahoraIngreso)  FILTROS:   Año: " & cmbAnio.Text & ",   se consideró: " & cmbConsiderar.Text
    Select Case cmbTipoRep.ListIndex
    Case 0
        ml_Titulo = "ESTANCIA HOSPITALARIA"
    Case 1
        ml_Titulo = "ESTANCIA HOSPITALARIA CONSOLIDANDO POR DEPARTAMENTOS"
    Case 2    'por un Servicio
        ml_Titulo = "ESTANCIA HOSPITALARIA POR ESPECIALIDAD"
    ...
    Case 3    'por 2 Especialidades
        ml_Titulo = "ESTANCIA HOSPITALARIA CONSOLIDANDO DOS SERVICIOS"
        If cmbIdDepartamento1.Text = "" Then
