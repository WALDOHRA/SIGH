...
Begin VB.Form HMorbilidad 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Morbilidad Hospitalaria por Departamentos y/o Servicios"
   ClientHeight    =   7380
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   13395
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton btnCancelar 
         ...
         DisabledPicture =   "HMorbilidad.frx":0000
         DownPicture     =   "HMorbilidad.frx":04C4
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
      ...
      Begin VB.CommandButton btnAceptar 
         Caption         =   "Aceptar (F2)"
         DisabledPicture =   "HMorbilidad.frx":0E9C
         DownPicture     =   "HMorbilidad.frx":12FC
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame6 
         ...
         Begin VB.ComboBox cmbCol2 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "HMorbilidad.frx":1BE6
            Left            =   3345
            List            =   "HMorbilidad.frx":1BF3
         ...
         Begin VB.ComboBox cmbCol1 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "HMorbilidad.frx":1C0A
            Left            =   3345
            List            =   "HMorbilidad.frx":1C17
            Style           =   2  'Dropdown List
            TabIndex        =   64
            Top             =   240
            Width           =   1530
         ...
         Begin VB.ComboBox cmbCol4 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "HMorbilidad.frx":1C2E
            Left            =   3345
            List            =   "HMorbilidad.frx":1C3B
            Style           =   2  'Dropdown List
            TabIndex        =   61
            Top             =   1410
            Width           =   1530
         ...
         Begin VB.ComboBox cmbCol3 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "HMorbilidad.frx":1C52
            Left            =   3345
            List            =   "HMorbilidad.frx":1C5F
            Style           =   2  'Dropdown List
            TabIndex        =   59
            Top             =   1020
            Width           =   1530
         ...
         Begin VB.ComboBox cmbCol6 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "HMorbilidad.frx":1C76
            Left            =   3330
            List            =   "HMorbilidad.frx":1C83
            Style           =   2  'Dropdown List
            TabIndex        =   56
            Top             =   2175
            Width           =   1530
         ...
         Begin VB.ComboBox cmbCol5 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "HMorbilidad.frx":1C9A
            Left            =   3330
            List            =   "HMorbilidad.frx":1CA7
            Style           =   2  'Dropdown List
            TabIndex        =   53
            Top             =   1785
            Width           =   1530
         ...
         Begin VB.ComboBox cmbCol8 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "HMorbilidad.frx":1CBE
            Left            =   3315
            List            =   "HMorbilidad.frx":1CCB
            Style           =   2  'Dropdown List
            TabIndex        =   50
            Top             =   2955
            Width           =   1530
         ...
         Begin VB.ComboBox cmbCol7 
            ...
            EndProperty
            Height          =   330
            ItemData        =   "HMorbilidad.frx":1CE2
            Left            =   3315
            List            =   "HMorbilidad.frx":1CEF
            Style           =   2  'Dropdown List
            TabIndex        =   47
            Top             =   2565
            Width           =   1530
      ...
      Begin VB.ComboBox cmbDiagnosticos 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "HMorbilidad.frx":1D06
         Left            =   1425
         List            =   "HMorbilidad.frx":1D10
         Style           =   2  'Dropdown List
         TabIndex        =   39
         Top             =   720
         Width           =   1875
      ...
      Begin VB.ComboBox cmbDistrito 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "HMorbilidad.frx":1D25
         Left            =   1440
         List            =   "HMorbilidad.frx":1D2F
         Style           =   2  'Dropdown List
         TabIndex        =   29
         Top             =   1365
         Width           =   1875
      ...
      Begin VB.ComboBox cmbTipoRep 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "HMorbilidad.frx":1D44
         Left            =   7290
         List            =   "HMorbilidad.frx":1D54
         Style           =   2  'Dropdown List
         TabIndex        =   6
         Top             =   1980
         Width           =   5760
      ...
      Begin VB.ComboBox cmbTipoDx 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "HMorbilidad.frx":1DBE
         Left            =   11160
         List            =   "HMorbilidad.frx":1DCB
         Style           =   2  'Dropdown List
         TabIndex        =   4
         Top             =   180
         Width           =   1995
      ...
      Begin VB.ComboBox cmbSexo 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "HMorbilidad.frx":1DFC
         Left            =   6930
         List            =   "HMorbilidad.frx":1E09
         Style           =   2  'Dropdown List
         TabIndex        =   3
         Top             =   180
         Width           =   1785
...
Private WithEvents oRptMortalidad As RptHMorbilidad
Attribute oRptMortalidad.VB_VarHelpID = -1
...
Sub btnAceptar_Click()
    If ValidaDatosObligatorios Then
        Me.MousePointer = 11
        'Dim oRptMortalidad As New RptHMorbilidad
...
Function ValidaDatosObligatorios() As Boolean
    ...
    ml_TextoDelFiltro = "FILTROS:   F.Alta Médica: (" & txtFechaInicio.Text & " hasta " & txtFechaFin.Text & "),   Tipo Dx: " & cmbTipoDx.Text
    ...
    Case 0
        ml_Titulo = "MORBILIDAD HOSPITALARIA"
    Case 1
        ml_Titulo = "MORBILIDAD HOSPITALARIA POR DEPARTAMENTO"
    ...
    Case 2    'por un Servicio
        ml_Titulo = "MORBILIDAD HOSPITALARIA POR ESPECIALIDAD"
        If cmbIdDepartamento1.Text = "" Then
           sMensaje = sMensaje + "Por favor elija el Departamento" + Chr(13)
        End If
    ...
    Case 3    'por 2 Especialidades
        ml_Titulo = "MORBILIDAD HOSPITALARIA CONSOLIDANDO DOS SERVICIOS"
        If cmbIdDepartamento1.Text = "" Then
...
Private Sub Form_Load()
    '
    Set oRptMortalidad = New RptHMorbilidad
...
Sub CargaCombos()
       ...
       Set mo_cmbTipoDx.RowSource = mo_AdminServiciosComunes.SubclasificacionDiagnosticosSeleccionarDxHospEgreso
...
Private Sub oRptMortalidad_ProgressActualizaValor(lnValorActual As Long, lnValorTotal As Long)
