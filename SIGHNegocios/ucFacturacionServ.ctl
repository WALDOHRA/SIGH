...
Begin VB.UserControl ucFacturacionServ 
   ClientHeight    =   5730
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   11685
   ...
   End
End
Attribute VB_Name = "ucFacturacionServ"
                ...
                Case Else
                    ...
                    Case sghServicio
                        ...
                        Else
                           ...
                           Case sghCptSoloLabPatologiaC
                              Set rs = mo_AdminCaja.ServiciosFiltrarParaCajero(sNombre, lIdTipoFinanciamiento, sghPtoCargaPatologiaClinica)
                           Case sghCptSoloLabAnatomiaP
                              Set rs = mo_AdminCaja.ServiciosFiltrarParaCajero(sNombre, lIdTipoFinanciamiento, sghPtoCargaAnatomiaPatologica1)
                           Case sghCptSoloLabBancoS
                              Set rs = mo_AdminCaja.ServiciosFiltrarParaCajero(sNombre, lIdTipoFinanciamiento, sghPtoCargaBancoSangre1)
                           Case Else
...
Private Sub InicializarLaGrilla(oGrilla As SSUltraGrid)
    ...
    oGrilla.Font.Name = "Arial narrow"
    oGrilla.Font.Size = "8"
    ...
    oGrilla.Bands(0).Columns("TotalPorPagar").Hidden = True
    ...
    oGrilla.Bands(0).Columns("NombreProducto").Width = 5200   '9000
...
Property Get DevuelveProductos() As Recordset
    'Se debe utilizar un clon del recrdset, ya que si se trabaja directamente con el recordset
    'que esta asociado a la grilla ocurre errores en los metodos movenext, movefirst, etc.
    Set DevuelveProductos = mrs_FacturacionProductos.Clone()
End Property
