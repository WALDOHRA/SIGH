...
Begin VB.Form PacientesCuentas 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Cuentas de Paciente"
   ClientHeight    =   5520
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   15105
   Icon            =   "PacientesCuentas.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton btnCancelar 
         ...
         DisabledPicture =   "PacientesCuentas.frx":0CCA
         DownPicture     =   "PacientesCuentas.frx":118E
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
         ...
         Height          =   700
         Left            =   7642
         Picture         =   "PacientesCuentas.frx":167A
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   225
         Width           =   1365
      ...
      Begin VB.CommandButton btnAceptar 
         Caption         =   "Aceptar (F2)"
         DisabledPicture =   "PacientesCuentas.frx":1B66
         DownPicture     =   "PacientesCuentas.frx":1FC6
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
         ...
         Height          =   700
         Left            =   6097
         Picture         =   "PacientesCuentas.frx":243B
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   210
         Width           =   1365
   ...
   End
End
Attribute VB_Name = "PacientesCuentas"
