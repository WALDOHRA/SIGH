...
Begin VB.UserControl ucCatServicioHospLista 
   ClientHeight    =   7935
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9975
   ...
   Begin VB.Frame fraBusqueda 
      ...
      Begin VB.CommandButton btnLimpiar 
         Height          =   315
         Left            =   8550
         Picture         =   "ucCatalogoServicioHospLista.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   210
         Width           =   1215
      ...
      Begin VB.CommandButton btnBuscar 
         Height          =   315
         Left            =   7140
         Picture         =   "ucCatalogoServicioHospLista.ctx":2BDC
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   210
         Width           =   1305
   ...
   Begin UltraGrid.SSUltraGrid grdServicios 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Override        =   "ucCatalogoServicioHospLista.ctx":5825
   ...
   End
End
Attribute VB_Name = "ucCatServicioHospLista"
...
Public Sub RealizarBusqueda()
    If Trim(txtCodigo.Text) = "" And Trim(txtNombre.Text) = "" Then
        ...
        Exit Sub
    End If
    Dim lIdFiltroTipo As Long
    Dim sCadenaBuscar As String
    
    If Trim(txtCodigo.Text) <> "" Then
       txtNombre.Text = ""
       lIdFiltroTipo = 1
       sCadenaBuscar = txtCodigo.Text
    Else
       txtCodigo.Text = ""
       lIdFiltroTipo = 2
       sCadenaBuscar = txtNombre.Text
    End If

    Set grdServicios.DataSource = mo_ReglasCaja.SeleccionarServiciosPorNombreOCodigoSegunTipofinanciamientoYpuntoCarga(lIdFiltroTipo, _
                                sCadenaBuscar, ml_IdTipoFinanciamiento, ml_IdPuntoCarga, ml_TipoServicioOfrecido)
...
Sub ConfigurarGrilla()
    ...
    grdServicios.Bands(0).Columns("PrecioUnitario").Hidden = True
    
    grdServicios.Bands(0).Columns("PrecioUnitario").Hidden = True
    grdServicios.Bands(0).Columns("Activo").Hidden = True
    grdServicios.Bands(0).Columns("idPuntoCarga").Hidden = True
    grdServicios.Bands(0).Columns("SeUsaSinPrecio").Hidden = True
    grdServicios.Bands(0).Columns("NombreProducto").Hidden = True
End Sub
